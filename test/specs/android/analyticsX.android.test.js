...
describe('AnalyticsX Android NML - BrowserStack', () => {
  let eyes;
  ...
  before(async () => {
    ...
    eyes.setBatch(new BatchInfo('JS BrowserStack | Static / Slicing Dynamic | NML | Android AnalyticsX'));
  ...
  it('validates the AnalyticsX app flow', async () => {
    ...
    if (!(await loginButton.isDisplayed())) {
      await browser.execute('mobile: scrollGesture', {
        left: 100, top: 300, width: 200, height: 600, direction: 'down', percent: 0.75,
      });
    }

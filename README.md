# typescript-wdio-appium-nml-ios-multi-device-perfecto

WDIO + Applitools NML (TypeScript) — iOS on Perfecto (multi-device variant).

Ported from `javascript-wdio-appium-nml-ios-multi-device-perfecto`. Runs
`analyticsX_nml_multidevice.ios.test.ts`, which uses Applitools'

...
/**
 * iOS AnalyticsX App — Applitools NML + BrowserStack Real Device
 *
 * ENV VARS:
 ...
 */
public class AnalyticsXIOSBrowserStackTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        eyes.setBatch(new BatchInfo("Java BrowserStack | NML | iOS AnalyticsX"));

...
/**
 * iOS AnalyticsX App — Applitools NML (multi-device) + BrowserStack Real Device
 *
 * ENV VARS:
 ...
 */
public class AnalyticsXIOSBrowserStackMultidevice_Test {

    // ── App ID ──────────────────────────────────────────────────────────────
    // TODO: upload AnalyticsXUIKit.ipa via the BrowserStack App Automate Upload API.
    private static final String APP_ID = "bs://6c1dc09410a257e5bb7656fc9bab781f58190123";
    ...
    public static void main(String[] args) throws Exception {
        ...
        bstackOptions.put("projectName",  "Applitools iOS AnalyticsX");
        bstackOptions.put("buildName",    "Applitools-iOS-AnalyticsX-Build");
        bstackOptions.put("sessionName",  "Applitools-iOS-AnalyticsX-Test");
        ...
        eyes.setBatch(new BatchInfo("Java BrowserStack | NML | iOS AnalyticsX | Multi Device"));

        try {

            eyes.open(
                    driver,
                    "BrowserStack iOS AnalyticsX App",

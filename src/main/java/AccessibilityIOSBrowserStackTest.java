...
/**
 * iOS Accessibility App — Applitools NML + BrowserStack Real Device
 *
 * ENV VARS:
 ...
 */
public class AccessibilityIOSBrowserStackTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ── NML ─────────────────────────────────────────────────────────────
        // Eyes.setMobileCapabilities injects appium:processArguments. BrowserStack
        // does not require it to be nested under bstack:options, so it stays a
        ...
        eyes.setBatch(new BatchInfo("Java BrowserStack | NML | iOS Accessibility"));

...
/**
 * Android AnalyticsX App — Applitools NML Multi-Device + Sauce Labs Real Device
 *
 * ENV VARS:
 ...
 */
public class AnalyticsXAndroidSauceLabsMultidevice_Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setBatch(new BatchInfo("Java SauceLabs | NML | Android AnalyticsX | Multi Device"));

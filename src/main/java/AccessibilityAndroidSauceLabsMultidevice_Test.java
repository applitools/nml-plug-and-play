...
/**
 * Android Accessibility App — Applitools NML Multi-Device + Sauce Labs Real Device
 *
 * ENV VARS:
 ...
 */
public class AccessibilityAndroidSauceLabsMultidevice_Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setBatch(new BatchInfo("Java SauceLabs | NML | Android Accessibility | Multi Device"));
